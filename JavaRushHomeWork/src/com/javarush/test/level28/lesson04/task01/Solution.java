...
public class Solution
{
    ...
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        {
            a = new AtomicInteger(pool.incrementAndGet());
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String name = String.format("%s-pool-%s-thread-%s", defaultGroup.getName(), a.get(), b.get());

            Thread newThread = new Thread(defaultGroup, r, name);
